...
describe("edit summary", () => {
  ...
  test("multi-line replace shows range and delta", async () => {
    ...
    const result = await edit({
      file_path: path,
      edits: [{ checksum: cs, range: `${h2}.2-${h4}.4`, content: "xxx" }],
    });
  ...
  test("replace with same line count shows \u00b10", async () => {
    ...
    const result = await edit({
      file_path: path,
      edits: [{ checksum: cs, range: `${lineHash("aaa")}.1`, content: "xxx" }],
    });
  ...
  test("single-line deletion", async () => {
    ...
    const result = await edit({
      file_path: path,
      edits: [{ checksum: cs, range: `${lineHash("bbb")}.2`, content: "" }],
    });
  ...
  test("no-op edit includes summary", async () => {
    ...
    const result = await edit({
      file_path: path,
      edits: [{ checksum: cs, range: `${lineHash("aaa")}.1`, content: "aaa" }],
    });
  ...
  test("batch edit shows one summary line per op", async () => {
    ...
    const result = await edit({
      file_path: path,
      edits: [
        { checksum: cs, range: `${h1}.1`, content: "xxx" },
        { checksum: cs, range: `+${h3}.3`, content: "yyy" },
      ],
    });
